...
class BookInventory(book_inventory_pb2_grpc.BookInventoryServicer):
    ...
    def CreateBook(self, request, context):
        ...
        return book_inventory_pb2.CreateBookResponse(book = book_response, message = "Book Created Succesfully");
        ...
        for i in db.list_of_books:
            for key, val in i.items():
                if (key == "ISBN"  and  val == value) :
                    ...
                    return book_inventory_pb2.GetBookResponse(book = book_response, message = "Book retrieved Succesfully");
        return book_inventory_pb2.GetBookResponse(book = None, message = "Book not retrieved Succesfully");
